...
if exists("$XDG_CONFIG_HOME")
  ...
  autocmd! BufNewFile,BufRead $HOME/.config/kitty/*.conf    set ft=kitty syntax=kitty
  autocmd! BufNewFile,BufRead $HOME/.config/kitty/*.session set ft=kitty-session syntax=kitty-session
endif
