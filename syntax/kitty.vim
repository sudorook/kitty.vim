...
syn keyword kittyKeyword contained
  ...
  \ color14 color15 color16 color17 color18 color19 color20 color21 color22
  \ color23 color24 color25 color26 color27 color28 color29 color30 color31
  \ color32 color33 color34 color35 color36 color37 color38 color39 color40
  \ color41 color42 color43 color44 color45 color46 color47 color48 color49
  \ color50 color51 color52 color53 color54 color55 color56 color57 color58
  \ color59 color60 color61 color62 color63 color64 color65 color66 color67
  \ color68 color69 color70 color71 color72 color73 color74 color75 color76
  \ color77 color78 color79 color80 color81 color82 color83 color84 color85
  \ color86 color87 color88 color89 color90 color91 color92 color93 color94
  \ color95 color96 color97 color98 color99 color100 color101 color102
  \ color103 color104 color105 color106 color107 color108 color109 color110
  \ color111 color112 color113 color114 color115 color116 color117 color118
  \ color119 color120 color121 color122 color123 color124 color125 color126
  \ color127 color128 color129 color130 color131 color132 color133 color134
  \ color135 color136 color137 color138 color139 color140 color141 color142
  \ color143 color144 color145 color146 color147 color148 color149 color150
  \ color151 color152 color153 color154 color155 color156 color157 color158
  \ color159 color160 color161 color162 color163 color164 color165 color166
  \ color167 color168 color169 color170 color171 color172 color173 color174
  \ color175 color176 color177 color178 color179 color180 color181 color182
  \ color183 color184 color185 color186 color187 color188 color189 color190
  \ color191 color192 color193 color194 color195 color196 color197 color198
  \ color199 color200 color201 color202 color203 color204 color205 color206
  \ color207 color208 color209 color210 color211 color212 color213 color214
  \ color215 color216 color217 color218 color219 color220 color221 color222
  \ color223 color224 color225 color226 color227 color228 color229 color230
  \ color231 color232 color233 color234 color235 color236 color237 color238
  \ color239 color240 color241 color242 color243 color244 color245 color246
  ...
  \ scrollback_pager_history_size second_transparent_bg
