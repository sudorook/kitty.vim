...
syn keyword kittyKeyword contained
  ...
  \ allow_remote_control background background_image background_image_layout
  \ background_image_linear background_opacity background_tint
  \ bell_border_color bell_on_tab bell_path bold_font bold_italic_font
  \ box_drawing_scale clear_all_mouse_actions clear_all_shortcuts
  \ click_interval clipboard_control clipboard_max_size close_on_child_death
  ...
  \ color28 color29 color30 color31 color32 color33 color34 color35 color36
  \ color37 color38 color39 color40 color41 color42 color43 color44 color45
  \ color46 color47 color48 color49 color50 color51 color52 color53 color54
  ...
  \ color73 color74 color75 color76 color77 color78 color79 color80 color81
  \ color82 color83 color84 color85 color86 color87 color88 color89 color90
  ...
  \ color108 color109 color110 color111 color112 color113 color114 color115
  \ color116 color117 color118 color119 color120 color121 color122 color123
  \ color124 color125 color126 color127 color128 color129 color130 color131
  \ color132 color133 color134 color135 color136 color137 color138 color139
  \ color140 color141 color142 color143 color144 color145 color146 color147
  \ color148 color149 color150 color151 color152 color153 color154 color155
  \ color156 color157 color158 color159 color160 color161 color162 color163
  \ color164 color165 color166 color167 color168 color169 color170 color171
  ...
  \ color188 color189 color190 color191 color192 color193 color194 color195
  \ color196 color197 color198 color199 color200 color201 color202 color203
  \ color204 color205 color206 color207 color208 color209 color210 color211
  \ color212 color213 color214 color215 color216 color217 color218 color219
  \ color220 color221 color222 color223 color224 color225 color226 color227
  \ color228 color229 color230 color231 color232 color233 color234 color235
  \ color236 color237 color238 color239 color240 color241 color242 color243
  \ color244 color245 color246 color247 color248 color249 color250 color251
  \ color252 color253 color254 color255 command_on_bell
  \ confirm_os_window_close copy_on_select cursor cursor_beam_thickness
  \ cursor_blink_interval cursor_shape cursor_stop_blinking_after
  \ cursor_text_color cursor_underline_thickness default_pointer_shape
  \ detect_urls dim_opacity disable_ligatures draw_minimal_borders
  \ dynamic_background_opacity editor enable_audio_bell enabled_layouts env
  \ exe_search_path file_transfer_confirmation_bypass focus_follows_mouse
  \ font_family font_features font_size force_ltr foreground
  ...
  \ select_by_word_characters selection_background selection_foreground shell
  \ shell_integration single_window_margin_width startup_session
